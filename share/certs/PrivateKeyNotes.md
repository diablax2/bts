...
unlocked to sign the BTS-Qt.app bundle.
...
allowing somebody to distribute a BTS-Qt.app or BTS-qt-setup.exe with a valid
...
that the BTS-qt.exe file inside the installer had not been tampered with.
