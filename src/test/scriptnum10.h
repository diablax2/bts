...
#ifndef BTS_TEST_SCRIPTNUM10_H
#define BTS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BTS Core 0.10.0, for cross-comparison.
 */
public:
