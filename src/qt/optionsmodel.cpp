...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("strThirdPartyTxUrls"))
        settings.setValue("strThirdPartyTxUrls", "http://explorer.Bitcoinstake.org/tx/%s");
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "http://explorer.Bitcoinstake.org/tx/%s").toString();
