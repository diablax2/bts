...
#ifndef BTS_QT_BTSUNITS_H
#define BTS_QT_BTSUNITS_H
...
/** BTS unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BTSUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BTSUnits(QObject *parent);

    /** BTS units.
      @note Source: https://en.BTS.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTS,
...
typedef BTSUnits::Unit BTSUnit;

#endif // BTS_QT_BTSUNITS_H
