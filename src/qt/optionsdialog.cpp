    ...
    mapper(0)
{
    ...
    ui->BTSAtStartup->setToolTip(ui->BTSAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->BTSAtStartup->setText(ui->BTSAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("http://explorer.Bitcoinstake.org/tx/%s");
#endif

    ui->unit->setModel(new BTSUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->BTSAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBTSConfButton_clicked()
{
