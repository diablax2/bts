...
#ifndef BTS_QT_BTSGUI_H
#define BTS_QT_BTSGUI_H
...
/**
  BTS GUI main class. This class represents the main window of the BTS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BTSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BTSGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~BTSGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a BTS wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
