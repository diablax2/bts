...
#ifndef BTS_WALLET_BTSTECH_H
#define BTS_WALLET_BTSTECH_H
...
#define BTSTECH_DEFAULT_INPUT_DELAY 1
#define BTSTECH_DEFAULT_OUT_DELAY 10
#define BTSTECH_DEFAULT_ENTROPY 4
