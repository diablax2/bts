...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CBTSAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CBTSAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CBTSAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CBTSAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CBTSAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBTSAddress(arr[0].get_str()).Get() == demoAddress.Get());
