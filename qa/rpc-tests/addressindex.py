...
class AddressIndexTest(BTSTestFramework):
    ...
    def run_test(self):
        ...
        print("Testing querying txids by range of block heigBTS..")
        ...
        # Check that deltas can be returned from range of block heigBTS
