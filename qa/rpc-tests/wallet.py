...
class WalletTest (BTSTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BTS from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BTS with subtract fee from amount
        ...
        # Sendmany 10 BTS with subtract fee from amount
        ...
        #     '-zapwallettxes=1',
        #     '-zapwallettxes=2',
        #     # disabled until issue is fixed: https://github.com/BTS/BTS/issues/7463
        #     # '-salvagewallet',
        # ]
