...
class RawTransactionsTest(BTSTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid BTS address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid BTS address" in e.error['message'])
