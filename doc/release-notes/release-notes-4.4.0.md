...
- Fee to create a Proposal: 50 BTS
...
You can read more about [NPIP0003 on the NPIP GitHub](https://github.com/BTS/npips/blob/master/npip-0003.mediawiki).

## Community Fund Contribution Increase

The Version Bit 16 will signal for the soft fork to increase the Community Fund contribution from 0.25 BTS to 0.50 BTS per block. 

You can read more about [NPIP0004 on the NPIP GitHub](https://github.com/BTS/npips/blob/master/npip-0004.mediawiki).
...
```
createproposal BTSaddress amount duration "desc" fee

Arguments:
1. "BTSaddress" (string, required) The BTS address where coins would be sent if the proposal is approved.
2. "amount" The amount in BTS to request. eg 100
...
2. "amount" (numeric or string, required) The amount in BTS to withdraw. eg 10
...
Donate BTS from your wallet to the commnuity fund

Arguments:
1. "amount" (string, required) The amount of BTS to donate
```
...
### Other modifications in the BTS client:
