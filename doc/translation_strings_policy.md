...
This document provides guidelines for internationalization of the BTS Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `BTS_en.ts` remains unchanged.
